...
class CfdiInvoiceAttachment(models.TransientModel):
    ...
    def get_or_create_product(self, default_code, product_name, clave_unidad, unit_price, clave_producto, sale_ok=True, purchase_ok=False):
        ...
        if not product_exist:
            ...
            #sat_code = self.env['product.unspsc.code'].search([('code','=',clave_producto)], limit=1) se mueve arriba junto con raise
            ...
            product_vals = {'default_code': default_code, 'name': sat_code.name, 'standard_price': unit_price,
                            ...
                            'description': 'Nombre asignado por el proveedor: '+ str(product_name)}
